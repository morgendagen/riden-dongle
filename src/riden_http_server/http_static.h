...
static const char HTML_CONTROL_BODY[] PROGMEM = 
    ...
    "  <table class='control'>"
    "    <tbody>"
    "      <colgroup><col width='10%' /><col width='1%' /><col width='1%' /><col width='20%' /><col width='50%' /></colgroup>"
    ...
    "      : 'true';"
    "    set_data("
    "      '{ \"out_v\": 12.34, \"out_c\": 1.23, \"set_v\": 12.34, \"set_c\": 1.23, \"out_on\": ' + i + ', \"cvmode\": ' + i + ', \"batt\": ' + i + ' }'"
    "    );"
    "    document.body.style.cursor = 'default';"
    "  }"
    "  function ex() {"
